...
plot_obs = None
scenario = 'energy' # 'basic', 'energy', 'sdf'
match scenario:
    case 'basic':
...
# DUENNES OBSTACLE von r0 zu r0
waypoints = [r0, r3] # good for energy stuff because gamma has higher absolute mag than necessary
